...
const SectionElectricidad = () => {
    return (
        <div className='w-full flex my-10 md:my-0 flex-col items-center  h-fit'>
            ...
            <div className='md:w-[55vw] w-[80%] mt-32 h-fit rounded-full flex items-center justify-center py-3  border-[7px] border-[#0B78BB]'>
                <div className='w-[30px] h-[30px] bg-[#0B78BB] rounded-full'></div>


                <h2 className='md:text-[83px] text-[26px] text-[#0B78BB] font-bold ml-5 md:ml-12'>ELECTRICIDAD</h2>

            </div>

            <div className='w-full flex flex-col items-center px-[5%] mt-10'>
                <p className='text-[#1D5E9D] text-[14px] md:text-[32px]'>
