    ...
    return (
        <div
            ...
            <div className='w-full h-fit pt-[55%] px-5 md:px-20'>
                ...
                transition={{ duration: 0.7 }}
                className='md:text-[80px] text-[32px] mt-5 text-white font-bold uppercase'>¿quiénes somos?</motion.h2>
                <motion.h2 
                initial={{
                    translateX: -50,
                    opacity: 0.2
                ...
                transition={{ duration: 0.7 }}
                className='md:text-[80px] text-[32px] -mt-3 md:-mt-8 text-[#1D5E9D] fill-[#1D5E9D] text-stroke-white font-bold uppercase'>¿quiénes somos?</motion.h2>
                <style>
                    {`
          .text-stroke-white {
        ...
        `}
                ...
                className='md:text-[80px] text-[32px] -mt-3 text-center opacity-10 text-[#1D5E9D] fill-[#1D5E9D] text-stroke-white font-bold uppercase'>NUESTROS SERVICIOS</motion.h2>
                ...
                transition={{duration:0.8}}
                className='md:text-[80px] text-[32px] -mt-3 text-center md:-mt-10 opacity-60 text-[#1D5E9D] fill-[#1D5E9D] text-stroke-white font-bold uppercase'>NUESTROS SERVICIOS</motion.h2>
