        ...
        <>
            <div className='w-full relative flex overflow-hidden flex-col h-fit bg-[#1D5E9D] px-[8%]'>
                <div className='bg-white mx-auto h-fit py-2 md:py-1 rounded-full md:px-16 px-8 space-x-8 flex items-center'>
                    ...
                    <h2 className='md:text-[5vw] text-[20px] uppercase text-[#1D5E9D] font-bold'>paneles solares</h2>
                </div>

                <h2 className='md:w-[55%] w-[70%] text-white text-[12px] z-10 md:text-[2.5vw] mt-[10%] mb-[10%]'>
                ...
                <motion.div
                    ...
                    className='md:w-[50vw] md:max-w-[600px] w-[30%] h-full absolute right-0 top-36 md:top-28 bg-panelsolar bg-contain bg-no-repeat '
                    style={{
            ...
            <div className='w-full relative flex overflow-hidden flex-col h-fit px-[8%]'>
                <h2 className='text-[#1D5E9D] mt-10 text-[12px] md:text-[2.5vw]'>
